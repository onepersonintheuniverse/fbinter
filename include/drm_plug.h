 ...
 */
static inline void uh_oh(const char *m){ perror(m); exit(1); }

/**
 * @brief pick a CRTC connection
 */
static inline void pick_crtc(struct drm_state *s) {
...
static inline void dumbfb(struct drm_state *s) {
...
static inline void modeset(struct drm_state *s) {
